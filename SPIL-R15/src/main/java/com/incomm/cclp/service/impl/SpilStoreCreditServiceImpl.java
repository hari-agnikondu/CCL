...
@Service("com.incomm.cclp.service.impl.SpilStoreCreditServiceImpl")
public class SpilStoreCreditServiceImpl implements SpilCommonService {

	@Autowired
	private SpilDAO spilDAO;

	@Autowired
	SpilStoreCreditDAO spilStoreCreditdao;

	private static final Logger logger = LogManager.getLogger(SpilStoreCreditServiceImpl.class);
	...
	public String[] invoke(ValueDTO valueDto) throws ServiceException {
		...
		String[] response = spilStoreCreditdao.invoke(valueDto);
		logger.info(
