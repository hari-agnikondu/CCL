...
@Service("com.incomm.cclp.service.impl.SpilRedemptionUnlockServiceImpl")
public class SpilRedemptionUnlockServiceImpl implements SpilCommonService {

	@Autowired
	private SpilDAO spilDAO;

	@Autowired
	SpilRedemptionUnlockDAO spilRedemptionUnlockdao;
	...
	public String[] invoke(ValueDTO valueDto) throws ServiceException {
		...
		String[] response = spilRedemptionUnlockdao.invoke(valueDto);
		logger.info(
				"Response for  Redemption Unlock  procedure: responseCode: {},  "
