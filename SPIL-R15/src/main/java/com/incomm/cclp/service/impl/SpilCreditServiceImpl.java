...
@Service("com.incomm.cclp.service.impl.SpilCreditServiceImpl")
public class SpilCreditServiceImpl implements SpilCommonService {

	@Autowired
	private SpilDAO spilDAO;

	@Autowired
	SpilCreditDAO spilCreditdao;

	private static final Logger logger = LogManager.getLogger(SpilCreditServiceImpl.class);
	...
	public String[] invoke(ValueDTO valueDto) throws ServiceException {
		...
		String[] response = spilCreditdao.invoke(valueDto);
		logger.info(
				"Response for SPIL Credit procedure: responseCode: {}, "
						+ "response msg: {}, ServiceProviderRefNum: {}, Balance: {}, Authorized Amopunt {},currency Code: {} ",
