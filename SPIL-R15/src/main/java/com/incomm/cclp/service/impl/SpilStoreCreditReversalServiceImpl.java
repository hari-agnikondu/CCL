...
@Service("com.incomm.cclp.service.impl.SpilStoreCreditReversalServiceImpl")
public class SpilStoreCreditReversalServiceImpl implements SpilCommonService {

	@Autowired
	private SpilDAO spilDAO;

	@Autowired
	SpilStoreCreditReversalDAO spilStoreCreditReversaldao;

	private static final Logger logger = LogManager.getLogger(SpilStoreCreditReversalServiceImpl.class);
	...
	public String[] invoke(ValueDTO valueDto) throws ServiceException {
		...
		String[] response = spilStoreCreditReversaldao.invoke(valueDto);
		logger.info(
				"Response for SPIL Store Credit procedure: responseCode: {}, "
