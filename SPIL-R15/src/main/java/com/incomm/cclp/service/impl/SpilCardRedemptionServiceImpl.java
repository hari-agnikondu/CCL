...
@Service("com.incomm.cclp.service.impl.SpilCardRedemptionServiceImpl")
public class SpilCardRedemptionServiceImpl implements SpilCommonService {

	@Autowired
	private SpilDAO spilDAO;

	@Autowired
	SpilCardRedemptionDAO spilCardRedemptiondao;
	...
	public String[] invoke(ValueDTO valueDto) throws ServiceException {
		...
		String[] response = spilCardRedemptiondao.invoke(valueDto);
		logger.info(
				"Response for card Redemption procedure: responseCode: {},"
						+ "response msg: {},Authorized Id: {},  Balance: {},Authorized Amt: {},currency Code: {} ,Purse Auth Response: {}",
