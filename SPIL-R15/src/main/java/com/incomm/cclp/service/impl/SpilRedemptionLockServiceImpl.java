...
@Service("com.incomm.cclp.service.impl.SpilRedemptionLockServiceImpl")
public class SpilRedemptionLockServiceImpl implements SpilCommonService {

	@Autowired
	private SpilDAO spilDAO;

	@Autowired
	SpilRedemptionLockDAO spilRedemptionLockdao;

	private static final Logger logger = LogManager.getLogger(SpilRedemptionLockServiceImpl.class);
	...
	public String[] invoke(ValueDTO valueDto) throws ServiceException {
		...
		String[] response = spilRedemptionLockdao.invoke(valueDto);
		logger.info(
				"Response for Redemption Lock  procedure: responseCode: {},  "
