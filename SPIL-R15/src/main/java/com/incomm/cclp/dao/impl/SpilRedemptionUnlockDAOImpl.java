...
import com.incomm.cclp.dao.SpilRedemptionUnlockDAO;
import com.incomm.cclp.dto.ValueDTO;
import com.incomm.cclp.exception.ServiceException;
import com.incomm.cclp.util.Util;

@Repository
public class SpilRedemptionUnlockDAOImpl implements SpilRedemptionUnlockDAO {
		...
		try {
			...
			Map<String, Object> resultMap = jdbcTemplate.call(new CallableStatementCreator() {
				public CallableStatement createCallableStatement(Connection con) throws SQLException {
					...
					CallableStatement cs = con.prepareCall(QueryConstants.SP_SPIL_REDEMPTION_UNLOCK); // need to call
																										// proper proce
					...
					logger.info(QueryConstants.SP_SPIL_REDEMPTION_UNLOCK);
					...
					cs.registerOutParameter(61, Types.VARCHAR);
			...
			logger.info(
					"Redemption Response: responseCode:{}, responoseMsg:{}, AuthorizedId:{}, Balance:{}, AuthorizedAmt:{}, currencyCode:{},purresp:{}",
					result[0], result[1], result[2], result[3], result[4], result[5], result[6]);

		} catch (Exception e) {
			logger.error("Error Occured in {} procedure. error message {}", QueryConstants.SP_SPIL_REDEMPTION_UNLOCK, e.getMessage(), e);
