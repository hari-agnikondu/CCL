...
@Repository
public class SpilRedemptionLockRevDAOImpl implements SpilRedemptionLockRevDAO {
	@Autowired
		...
		try {
			...
			Map<String, Object> resultMap = jdbcTemplate.call(new CallableStatementCreator() {
				public CallableStatement createCallableStatement(Connection con) throws SQLException {
					...
					CallableStatement cs = con.prepareCall(QueryConstants.SP_SPIL_REDEMPTION_LOCK_REVERSAL); // need to
																												// call
																												// proper
																												// proce
					...
					logger.info(QueryConstants.SP_SPIL_REDEMPTION_LOCK_REVERSAL);
					...
					logger.info("LastTxn date:" + lasttxndate);
			...
			logger.error("Error Occured in {} procedure. error message {}", QueryConstants.SP_SPIL_REDEMPTION_LOCK_REVERSAL, e.getMessage(),
					e);
