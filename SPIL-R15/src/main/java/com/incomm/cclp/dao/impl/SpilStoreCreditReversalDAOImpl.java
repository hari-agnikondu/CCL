...
import com.incomm.cclp.dao.SpilStoreCreditReversalDAO;
import com.incomm.cclp.dto.ValueDTO;
import com.incomm.cclp.exception.ServiceException;
import com.incomm.cclp.util.Util;

@Repository
public class SpilStoreCreditReversalDAOImpl implements SpilStoreCreditReversalDAO {
		...
		try {
			...
			Map<String, Object> resultMap = jdbcTemplate.call(new CallableStatementCreator() {
				public CallableStatement createCallableStatement(Connection con) throws SQLException {
					...
					CallableStatement cs = con.prepareCall(QueryConstants.SP_SPIL_STORE_CREDIT_REVERSAL);
					logger.info(QueryConstants.SP_SPIL_STORE_CREDIT_REVERSAL);
			...
			logger.info("responseCode:{}, rsponseMsg: {}, AuthorizedId:{}, Balance:{}, AuthorizedAmt:{}, Currency code:{}", result[0],
					result[1], result[2], result[3], result[4], result[5]);

		} catch (Exception e) {
			logger.error("Error Occured in {} procedure. error message {}", QueryConstants.SP_SPIL_STORE_CREDIT_REVERSAL, e.getMessage(),
					e);
