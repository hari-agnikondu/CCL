...
public class BatchListener extends JobExecutionListenerSupport{
	...
	private static final Logger logger = LogManager.getLogger(BatchListener.class);
	...
	public void beforeJob(JobExecution jobExecution) {
		...
		logger.info("Before Finish Job! Status:"+jobExecution.getStatus()+" Exist Status:"+jobExecution.getExitStatus());
