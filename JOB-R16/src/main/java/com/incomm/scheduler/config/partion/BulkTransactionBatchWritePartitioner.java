...
public class BulkTransactionBatchWritePartitioner implements Partitioner {

	@Value("${SPLIT_VALUE}")
	private Integer splitvalue;
	
	private static final Logger logger = LogManager.getLogger(BulkTransactionBatchWritePartitioner.class);
