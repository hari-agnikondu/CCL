...
@Repository
public class CCFGenerationDAOImpl extends JdbcDaoSupport implements CCFGenerationDAO {

	private static final Logger logger = LogManager.getLogger(CCFGenerationDAOImpl.class);
	...
	@Override
	public void getAllOrdersToGenerateCCF(String orderId, String vendorId,CCFRowCallbackHandler handler) {

		getJdbcTemplate().query(ScriptUtils.GET_ALL_MANUAL_ORDERS_TO_GENERATE_CCF,
				  handler, vendorId, orderId);

	}
	
	@Override
	public Map<String,Object> getCountAllOrdersToGenerateCCF(String orderId, String vendorId) {
		List<Map<String,Object>> list =  getJdbcTemplate().query(ScriptUtils.GET_COUNT_ALL_MANUAL_ORDERS_TO_GENERATE_CCF,
				   new ColumnMapRowMapper(),vendorId, orderId);
		 return list.get(0);
	}
	
	@Override
	public Map<String,Object> getOrderInfo(String orderId, String vendorId){
		List<Map<String,Object>> list = getJdbcTemplate().query(ScriptUtils.GET_ALL_MANUAL_ORDERS_INFO_TO_GENERATE_CCF,
				  new ColumnMapRowMapper(), vendorId, orderId);
		return list.get(0);
	}
	...
	@Override
	public void updateCardStatus(String orderId, String psFileName, String orderStatus,String cardStatus) {
		
		getJdbcTemplate().update(ScriptUtils.UPDATE_CARD_STATUS_ALL,psFileName, orderStatus, orderId);
		getJdbcTemplate().update(ScriptUtils.UPDATE_CARD_ALL,cardStatus,orderId);
	}
	
	@Override
	public void updateCard(String hashPancode, String status) {
		
		getJdbcTemplate().update(ScriptUtils.UPDATE_CARD,status,hashPancode);
	}
	...
	public Map<String, Object> getCCFFileName(String vendorId, String orderId) {
		...
		String typeOfOrder = String.valueOf(productIdAndOrderType.get("orderType"));
		...
		params.add(new SqlOutParameter("error", Types.VARCHAR));
			...
			public CallableStatement createCallableStatement(Connection con) throws SQLException {
				...
				logger.info("Response of the procedure "+resultMap.get("error"));
		}catch(Exception e) {
	...
	public Map<String, Object> getHeaderFileNumber(int insUser) {
		...
		try {
			...
			logger.info("Response of the procedure "+resultMap.get("errmsg"));
		} catch (Exception e) {
			logger.error(e.getMessage());
		}
		logger.info(CCLPConstants.EXIT);
	...
	public List<Map<String, Object>> getAllOrdersToGenerateCCF(String orderId, String vendorId,String orderLineItem) {
		...
		return getJdbcTemplate().queryForList(ScriptUtils.GET_ALL_ORDERS_TO_GENERATE_CCF_ORDER_LINE_ITEM,
	...
	public List<Map<String, Object>> getCCFFilesToDelete(String ccfFileDelGap) {
		...
		return getJdbcTemplate().queryForList(ScriptUtils.GET_CCF_FILES_TO_DELETE,ccfFileDelGap);	
	}

	@Override
	public String getProductNameByOrderId(String order) {
		
		return getJdbcTemplate().queryForObject(ScriptUtils.GET_PRODUCTNAME_BY_ORDERID,new Object[] {order},String.class);
	}

	@Override
	public String getUserId(String order) {
		
		return getJdbcTemplate().queryForObject(ScriptUtils.GET_USERID_BY_ORDERID,new Object[] {order},String.class);
	}

	

	@Override
	public List<Map<String, Object>> getAllOrdersToGenerateCCFF(String vendorId,String orderType) {
	
		return getJdbcTemplate().queryForList(ScriptUtils.GET_ALL_ORDERS_TO_GENERATE_CCF, vendorId,orderType);
	}

	@Override
	public List<String> getAllOrdersList(String orderType) {
		List<String> orderlist = null;
		orderlist=getJdbcTemplate().queryForList(ScriptUtils.GET_ALL_COMPLETED_ORDERS_LIST,new Object[] {orderType},String.class);
		return orderlist;
	}

	@SuppressWarnings("unchecked")
	@Override
	public List<String> getAllOrdersToGenerateSeparateCCF(String orderType) {
		List orderlist = null;
		orderlist=getJdbcTemplate().queryForList(ScriptUtils.GET_ALL_COMPLETED_ORDERS_TO_SEPARATE_CCF,orderType);
		return orderlist;
	}

	@Override
	public List<Map<String, Object>> getAllOrdersToGenerateSeparateCFF(String vendorId, String orderType,
			String orderId) {
		return getJdbcTemplate().queryForList(ScriptUtils.GET_ALL_ORDERS_TO_GENERATE_SEPARATE_CCF, vendorId,orderType,orderId);
	}
	...
	public List<Map<String,Object>> getGlobalParams(){
		...
		return getJdbcTemplate().queryForList(QueryConstants.GET_GLOBAL_PARAMETETS);
			
			
		}

	@Override
	public List<String> getAllVendorsLinkedToOrderPackageId(String order, String packageId) {
		
		List vendorList = null;
		vendorList=getJdbcTemplate().queryForList(ScriptUtils.GET_ALL_VENDOR_LINKED_TO_ORDER_AND_PACKAGE,order,packageId);
		return vendorList;
	}
	...
	public String getCCFFormatVersionByOrderId(String orderId) {
		...
		return getJdbcTemplate().queryForObject(ScriptUtils.GET_CCF_FORMAT_VERSION_BY_ORDER_ID,new Object[] {orderId}, String.class);
	}
