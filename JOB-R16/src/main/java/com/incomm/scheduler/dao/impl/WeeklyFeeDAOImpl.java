...
@Repository
public class WeeklyFeeDAOImpl extends JdbcDaoSupport implements WeeklyFeeDAO {

	private static final Logger log = LogManager.getLogger(WeeklyFeeDAOImpl.class);
	...
	public String callProcedure() {
		...
		try {
			...
			log.info("Calling the Procedure : {}", ScriptUtils.SP_CALC_WEEKLY_FEES);
