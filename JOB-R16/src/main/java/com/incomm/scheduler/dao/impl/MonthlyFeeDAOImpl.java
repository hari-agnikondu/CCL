...
@Repository
public class MonthlyFeeDAOImpl extends JdbcDaoSupport implements MonthlyFeeDAO {

	private static final Logger log = LogManager.getLogger(MonthlyFeeDAOImpl.class);
	...
	public String callMonthlyFeeProcedure() {
		...
		try {
			...
			log.info("Calling the Procedure : {}", ScriptUtils.SP_CALC_MONTHLY_FEES);
