...
public class CurrencyRateUploadJobListener extends JobExecutionListenerSupport {

	private static final Logger logger = LogManager.getLogger(CurrencyRateUploadJobListener.class);
