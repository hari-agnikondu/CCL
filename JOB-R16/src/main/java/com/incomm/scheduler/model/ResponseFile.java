...
public class ResponseFile extends BaseResourceAware
{
	String magicNumber;
	String status;
	String carrier;
	...
	public ResponseFile(Resource resource){
	...
	/**
	 * @param magicNumber the magic_Number to set
	 */
	...
	/**
	 * @param merchantName the merchant_Name to set
	 */
	...
	/**
	 * @param caseNumber the case_Number to set
	 */
	...
	/**
	 * @param palletNumber the pallet_Number to set
	 */
	...
	/**
	 * @param serialNumber the serial_Number to set
	 */
	...
	/**
	 * @param shipTo the ship_To to set
	 */
	...
	/**
	 * @param streetAddress1 the street_Address1 to set
	 */
	...
	/**
	 * @param streetAddress2 the street_Address2 to set
	 */
	...
	/**
	 * @param dcmsID the dCMS_ID to set
	 */
	...
	/**
	 * @param prodID the prod_ID to set
	 */
	...
	/**
	 * @param parentSerialNumber the parent_Serial_Number to set
	 */
