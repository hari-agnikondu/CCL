...
@Entity
@Audited
@Table(name="ROLE_PERMISSION_TEMP")
...
public class RolePermissionTemp implements Serializable {
	
	private static final long serialVersionUID = 1L;
	
	private RolePermissionTempId  primaryKey = new RolePermissionTempId();
