...
public class ClpUserDTO implements Serializable {
	...
	public ClpUserDTO(Long userId, String userLoginId, String lastLoginTime, String userName, String userEmail, Long userContactNumber, String userStatus, String checkerRemarks,
			Long insUser, Date insDate, Long lastUpdUser, Date lastUpdDate, List<GroupDTO> groups) {
		this.userId = userId;
		this.userLoginId = userLoginId;
		this.lastLoginTime = lastLoginTime;
		this.userName = userName;
	...
	public ClpUserDTO(Long userId, String userLoginId, String lastLoginTime, String userName, String userEmail, Long userContactNumber, String userStatus, String checkerRemarks,
			Long insUser, Date insDate, Long lastUpdUser, Date lastUpdDate, List<GroupDTO> groups, String accessStatus) {
		this.userId = userId;
		this.userLoginId = userLoginId;
		this.lastLoginTime = lastLoginTime;
		this.userName = userName;
