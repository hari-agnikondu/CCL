...
public class FulfillmentDTO implements Serializable {
	...
	public FulfillmentDTO(long fulFillmentSEQID, String fulfillmentID, String fulFillmentName,
			...
			String b2bVendorConfReq, String b2bPrinterRespIdentifier, String b2bConfFileIdentifier,
			String b2bCnFileIdentifier, long insUser, Date insDate, long lastUpdUser, Date lastUpdDate,
			String mftDestinationKey) {
		super();
