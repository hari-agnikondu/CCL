...
public class PackageDTO implements Serializable {
	...
	public PackageDTO(String packageId, String description, String replacementPackageId, String fulfillmentId,
			String isActive, Map<String, String> packageAttributes) {
		super();
	...
	public String toString() {
		return "PackageDTO [packageId=" + packageId + ", description=" + description + ", replacementPackageId="
				+ replacementPackageId + ", fulfillmentId=" + fulfillmentId + ", isActive=" + isActive + ", insUser="
