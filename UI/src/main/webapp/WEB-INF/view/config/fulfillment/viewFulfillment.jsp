...
<script type="text/javascript">
	...
	function checkCNfilereq() {
		...
		if (type.checked == true) {
			...
			//document.viewFulFillmentForm.b2bCnFileIdentifier.value = "";
		} else {
	...
	function checkAutoShipped() {
		var type = document.viewFulFillmentForm.isAutomaticShipped.value;
...
<div class="container">
 ...
 <ul  class="nav nav-tabs col-lg-6 col-lg-offset-3">
			<li class="active"><a href="#viewFulFillment" data-toggle="tab"
				class="hoverColor"><i class="glyphicon glyphicon-tags"></i>&nbsp;
				<spring:message code="fullFillment.viewFulFillmentLabel" /></a></li>
...
<div class="tabresp tab-content">
	...
	<form:form name="viewFulFillmentForm" id="viewFulFillmentForm"
		...
		<input id="viewFulfillmentSQID" name="viewFulfillmentSQID" type="hidden" value="${viewFulfillmentID}" /> 
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-8">
												<form:input path="fulFillmentName" id="fulFillmentName"
													...
													onkeypress="return allowAlphaNumericWithSpaceAndUnderScore(event)"
													onblur="validateFields(this.form.id,this.id)"
													type="textarea" minlength="2" maxlength="200" readonly="true" />
												<div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-8">
												<form:select path="isAutomaticShipped" 
													...
													disabled="true" onChange="checkAutoShipped();" >
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-8">
												<form:textarea path="replaceCcfFileFormat"
													...
													onblur="validateFields(this.form.id,this.id)"
													type="textarea" minlength="1"  maxlength="100" readonly="true" />
												<div>
											...
											<div class="col-lg-8">
													<div class="radiobox-checkline">
														<form:radiobutton value="enabled" path="b2bVendorConfReq"
															id="b2bCNFileReqYes" name="b2bCNFileReqYes" disabled="true" onclick="checkCNfilereq();"/>
														...
														<form:radiobutton value="disabled" path="b2bVendorConfReq"
															...
															data-skin="square" disabled="true"
										...
										<div class="col-lg-12" id="b2bCNFileIdentifierID">
											...
											<div class="col-lg-8">
												<form:input path="b2bCnFileIdentifier"
													...
													type="textarea" minlength="1" maxlength="20" readonly="true" />
											</div>
											<div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-8">
												<form:input path="b2bPrinterRespIdentifier"
												    ...
												    class="textbox textbox-large trim" type="textarea"
												    onblur="validateFields(this.form.id,this.id)"
													minlength="1" maxlength="20" readonly="true"/>
											</div>
											<div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-8">
												...
												<button type="button" class="btn btn-primary gray-btn"
													onclick="goBackToEditFulfilmentFromView();">
