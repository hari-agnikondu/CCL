...
<div class="body-container">
	...
	<form:form name="addCustomerProfileForm" id="addCustomerProfileForm"
		commandName="customerProfileForm" method="POST"
		class='form-horizontal'>
		<!-- action='customerProfileConfig' -->
		<div class="container">
			<section class="content-container">
				<article class="col-lg-12">
					<ul class="nav nav-tabs  col-lg-11 col-lg-offset-1">
						<li class="active SubMenu"><a href="#" data-toggle="tab"><spring:message
									code="customerProfile.addCustomerProfile" /></a></li>
					</ul>
							...
							<div class="form-inline">
								...
								<div class="col-lg-12">
									...
									<div class="ui-widget">
										...
										</select> <input type="text" name="parentCardData" id="parentCardData" />
										...
										<button type="button" id="viewCard" class="btn btn-primary"
											onclick="viewCard_add_edit()">
								...
								<div class="col-lg-12">
									...
									<div class="col-lg-8">
										<button type="button"
											onclick="saveCustomerProfile(this.form.id);"
											class="btn btn-primary">
										...
										<%-- <button type="button"
											onclick="setActionAttrOfForm(this.form.id,'showAddCustomerProfile');"
