                            ...
                            <div class="tab-pane fade in active graybox col-lg-9 col-lg-offset-1">
                                ...
                                <div class="col-lg-12">
                                    <c:if test="${showCopyFrom=='true' }">
                                        ...
                                        <form:hidden path="productId" id="productId" value="${productId}"/>
                                        <div class="col-lg-8">
                                            <form:select path="parentProductId" id="parentProductId">
                                                ...
                                                <button type="button" id="productGeneral"
                                                    class="btn btn-primary" onclick="getParentProductDetails()">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-8">
                                        <form:input
                                            ...
                                            onblur="validateTxnCount(this.form.id,this.id)" maxlength="2" />
                                        <div>
                                            <form:errors
                                                path="productAttributes['txnCountRecentStatement']"
                                                cssClass="fieldError" />
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-8">
                                        <form:input path="productAttributes['roboHelpUrl']"
                                            ...
                                            onblur="validateURL(this.form.id,this.id)" maxlength="500" />
                                        <div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-8">
                                        <form:input path="productAttributes['emailIdStatement']"
                                            ...
                                            autocomplete="off"
                                            onblur="validateEmail(this.form.id,this.id)" maxlength="50" />
                                        <div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-8">
                                        <form:select path="productAttributes['cardRenewReplaceProd']"
                                            id="cardRenewalOrReplacement"   onchange="replaceRenewalNewProduct()">
                                            <form:option value="SP" label="Same PAN" />
                                            <form:option value="NP" label="New PAN" />
                                            <form:option value="NPP" label="New Product" />
                                        </form:select>
                                        <div>
                                ...
                                <form:hidden path="partnerId" id="partnerId" value="${productGeneral.partnerId}"/>
                                
                                
                                <div class="col-lg-12" id="cardReplaceRenewalNewProdShow" style="display:none;">
                                
                                <div class="col-lg-12">
                                        <div class="col-lg-4">
                                            <label for="Replacement Product"><spring:message
                                                    code="Product.Replacement_Product" /></label>
                                        </div>
                                        
                                        <div class="col-lg-8">
                                            <form:select path="productAttributes['cardReplaceRenewalNewProd']" id="cardReplaceRenewalNewProd">
                                                <form:option value="-1" label="- - - Select - - -" />
                                        <form:options items="${productMap}" />
                                            ...
                                            <div>
                                                <span id="cardReplaceRenewalNewProd"></span>
                                            </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-8">
                                        <form:input path="productAttributes['cardExpiryPendingDays']"
                                            ...
                                            onblur="validateNonManFields(this.form.id,this.id)"
                                            onkeyup="return isNumeric(this)" maxlength="3" />
                                        <div>
                                            <form:errors
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-8">
                                        <form:input path="productAttributes['maxCardsPerCust']"
                                            ...
                                            onblur="validateNonManFields(this.form.id,this.id)"
                                            onkeyup="return isNumeric(this)" maxlength="2" />
                                        <div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-8">
                                        <form:select path="productAttributes['chwAuthType']" id="chwUserAuthentication"
                                            class="dropdown-medium" onchange="return validateDropDown(this.form.id,this.id);">
                                            <form:option value="-1" label="--- Select ---" />
                                        ...
                                        <c:choose>
                                            <c:when test="${cardBlocking}">
                                                <div class="col-lg-4">
                                                    <form:radiobutton value="true"
                                                        ...
                                                        checked="checked" onclick="showBlockingFields()"/>
                                                ...
                                                <div class="col-lg-4">
                                                    <form:radiobutton value="false"
                                                        ...
                                                        data-skin="square" data-color="blue" onclick="hideBlockingFields()"/>
                                                    <label class='radiobox-line' for="cardBlocking"><spring:message
                                            ...
                                            <c:otherwise>
                                                <div class="col-lg-4">
                                                    <form:radiobutton value="true"
                                                        path="productAttributes['cardBlocking']"
                                                        id="cardBlocking_Enable" name="cardBlocking" onclick="showBlockingFields()"/>
                                                    <label class='radiobox-line' for="cardBlocking"><spring:message
                                                            code="Product.cardBlocking_Status_Enable" /></label>
                                                </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-8"><form:select path="productAttributes['startTimeHours']" name="startTimeHours" id="startTimeHours">
                                    ...
                                    /&nbsp;<form:select name="startTimeMins" id="startTimeMins" path="productAttributes['startTimeMins']">
                           ...
                           <%--      
                            ...
                            <div class="col-lg-12">
                                            ...
                                            <c:when test="${redeemSplitTender}">
                                                <div class="col-lg-4">
                                                    <form:radiobutton value="true"
                                                        ...
                                                        id="redeemSplitTender_Enable" name="redeemSplitTender"
                                                        checked="checked"/>
                                                ...
                                                <div class="col-lg-4">
                                                    <form:radiobutton value="false"
                                                        path="productAttributes['redeemSplitTender']"
                                                        id="redeemSplitTender_Disable" name="redeemSplitTender"
                                                        data-skin="square" data-color="blue"/>
                                                    <label class='radiobox-line' for="redeemSplitTender"><spring:message
                                            ...
                                            <c:when test="${redeemSplitTender}">
                                                <div class="col-lg-4">
                                                    <form:radiobutton value="true"
                                                        ...
                                                        id="redeemLockSplitTender_Enable" name="redeemLockSplitTender"
                                                        checked="checked"/>
                                                ...
                                                <div class="col-lg-4">
                                                    <form:radiobutton value="false"
                                                        path="productAttributes['redeemLockSplitTender']"
                                                        id="redeemLockSplitTender_Disable" name="redeemLockSplitTender"
                                                        data-skin="square" data-color="blue"/>
                                                    <label class='radiobox-line' for="redeemLockSplitTender"><spring:message
                                ...
                                <div class="col-lg-12 text-center">
                                    <button type="submit" id="productGeneral"
                                        class="btn btn-primary btn-normal"
                                        onclick="return generalSubmit(this.form.id,event)">
