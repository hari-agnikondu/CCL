...
<div class="tabresp tab-content">
			...
			<div class="col-lg-12 ">
				...
				<div class="col-lg-6">
						<label for="copyFrom"><spring:message
								code="product.alerts.copyFrom" /></label>
					</div>
					<form:hidden path="productId"  />  
					<div class="col-lg-6">
							<form:select path="parentProductId" id="parentProductIdAlert" class="dropdown-medium">
							 <form:option value="-1" label="- - - Select - - -"/> 
										<form:options items="${parentProductMap}"/>
										</form:select>
								
										
							<button type="button" id="productAlerts" class="btn btn-primary"
							onclick="getAlertProductDetails()">
							<spring:message
								code="button.copy" />
						</button>
						<div><span id="parentProductIdError"></span></div>
					</div>
				</c:if>
				...
				<div class="col-lg-6">
					 ...
					 autocomplete="off" maxlength="50" class="textbox-large" onblur ="return validateEmailAlertMandatory(this.form.id,this.id)"/>	
				...
				<div class="col-lg-6">
					...
					<form:input path="alertAttributes['alertAppName']" id="alertAppName" name="alertAppName" 
					 ...
					 onblur ="validateAlerCheckWithoutPattern(this.form.id,this.id)" class="textbox-large"/>
					<div>
				...
				<div class="col-lg-6">
					...
					<form:input path="alertAttributes['alertSMSCode']" id="alertSMSCode" name="alertSMSCode" 
					 ...
					 onblur ="validateAlertswithMinMaxLengthCheck(this.form.id,this.id)"/>
					<div>
	...
	<div class="col-lg-6">
		...
		<form:input path="alertAttributes['alertMinBalance']" id="alertMinBalance" name="alertMinBalance" 
		 ...
		 onkeyup="isNumericproductNameId(this)" 
		  onblur="return validateAlertwithNumericandMaxlength(this.form.id,this.id)"/>
		<div>
	...
	<div class="col-lg-6">
		...
		<form:select path="alertAttributes['alertCardStatus']" id="alertCardStatus" name="alertCardStatus" 
		 autocomplete="off" maxlength="6" class="textbox-large" multiple="multiple">
...
<div class="col-lg-12">
		...
		<label for="Select Language"><spring:message
		 ...
		 <div class="col-lg-6">
			<form:select path="alertAttributes['alertLanguage']" id="alertLanguage" class="dropdown-medium" >
	...
	<div class="col-lg-6">
		...
		<form:checkbox path="alertAttributes['alertOptIn']"
				id="alertOptIn" name="alertOptIn" value="Yes" />
		<div>
...
<div class="modal fade" id="define-constant-update_${msg.alertShortName}" tabindex="-1"
	...
	type="textarea"  style="min-height: 168px;" maxlength="1000"/>
	<div>
		<form:errors path="" cssClass="fieldError"  /></div>
	</div>
	</div>
...
<div class="col-lg-3">
		<form:checkbox path="alertAttributes['alertMode_SMS_${msg.alertShortName}']"
				id="alertMode_SMS_${msg.alertShortName}" name="alertMode_SMS_${msg.alertShortName}" value="SMS" />
</div>				
<div class="col-lg-3">
		<form:checkbox path="alertAttributes['alertMode_EMAIL_${msg.alertShortName}']"
				id="alertMode_EMAIL_${msg.alertShortName}" name="alertMode_EMAIL_${msg.alertShortName}" value="Email" />
</div>	
...
<!-- check boxes ends here -->				
				...
				<div class=""></div>
					<div class="">
						<button type="submit" id="productAlerts" class="btn btn-primary"
							onclick="saveProductAlerts(this.form.id,event)">
							<i class="glyphicon glyphicon-saved"></i><spring:message code="product.alerts.update" />
						</button>
