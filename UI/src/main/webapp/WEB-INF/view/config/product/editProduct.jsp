...
<body class="dashboard" onload="onloadDiv()">
	...
	<div class="modal fade" id="define-constant-serial" tabindex="-1"
		...
		<div class="modal-dialog">
			<form:form class='form-horizontal' name="serialForm" id="serialForm"
				...
				<div class="modal-content">
					...
					<div id="feedBackTd" class="col-lg-6 col-lg-offset-3">
						...
						<c:if test="${statusFlag!='success' }">
							<p class="fieldError"
								style="text-align: center; font-weight: bold;" id="errorfield">
								<c:out value="${statusMessage }"></c:out>
							</p>
						</c:if>
					</div>
					<div class="modal-body col-lg-12">
						...
						<div class="col-lg-12">
							...
							<div class="col-lg-8">
								...
								<form:input path="productName" id="serialProductName"
									class="textbox-large" type="text" maxlength="100"
									readonly="true" onkeyup="return isAlphaNumericWithSpace(this);"
						...
						<div class="col-lg-12">
							...
							<div class="col-lg-8">
								...
								<p class="textbox-large" id="serialB2bUPC">
									<form:input path="upc" id="serialProductB2BUPC" type="text"
										name="b2bUPC" readonly="true"
						...
						<div class="col-lg-12" id="serailIntialB2BSerialNumQty">
							...
							<div class="col-lg-8">
								...
								<form:input path="prodAttributes['b2bInitSerialNumQty']"
									id="serialB2bInitSerialNumQty" class="textbox-large"
									type="text" max="50" onkeyup="return isNumeric(this)"
									onblur="validateFields(this.form.id,this.id);" />
							</div>
							<form:errors path="prodAttributes['b2bInitSerialNumQty']"
								id="serialB2bInitSerialNumQty" cssStyle="color:red" />
						</div>
					</div>
					<form:hidden path="productId" id="productId" name="productId" />

					<div class="modal-footer">
						<button type="button"
							onclick="submitSerialForm('generateSerialNumber','serialForm');"
							class="btn btn-primary">
							<i class="glyphicon glyphicon-plus"></i>
							<spring:message code="addProductserialNumberRequest.Submit" />
						</button>

						<button type="button" onclick="resetSerialForm();"
	...
	<!-- delete box ends -->
	<form:form name="editProductForm" id="editProductForm"
		action="/config/product/editProduct" method="POST"
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-8">
												...
												<form:select id="productPartnerName" name="partnerName"
													...
													onChange="getProgramIds(this.form.id,this.id);getSupportedPurses();getPartnerCurrency(this.form.id,this.id);setTimeout(checkPartnerCurrencyExist, 100);"
								...
								<div class="col-lg-8">
									...
									<div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-4" id="formFactor">
												<form:radiobutton path="prodAttributes['formFactor']"
													id="formFactorPhysical" name="formFactorPhysical"
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-2" id="productType">
											...
											<div class="col-lg-6">
												<button type="button" class="btn btn-primary"
													id="serialRequest" data-toggle="modal"
													data-target="#define-constant-serial" onclick="fetchData()">
													<!-- <i class='glyphicon glyphicon-backward'></i> -->
        ...
        <c:if
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-8">
												...
												<form:input type="textarea"
													...
													onblur="validateDate(this.form.id,this.id);"
				   ...
				   ${purse.extPurseId} 
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-8" id="internationalSupport">
												<form:radiobutton
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-4">
												<form:radiobutton path="prodAttributes['multiPurseSupport']"
													id="multiPurseSupport" name="multiPurseSupport"
													value="Disable" checked="checked" />
												<label class='radiobox-line'>Disable</label>
												<form:radiobutton path="prodAttributes['multiPurseSupport']"
													value="Enable" id="multiPurseSupport"
													name="multiPurseSupport" data-skin="square"
													data-color="blue" />
												<label class='radiobox-line'>Enable</label>
											</div>
					...
					<input type="hidden" name="otherdata" id="otherdata" value="${othertxns}"/>	 --%>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-8">
												<button type="button"
													onclick="goConfirmProduct(this.form.id,event);"
													class="btn btn-primary-table-button" id="search_submit"
...
<script>
	...
	$('#internationalSupport input[type=radio]').change(function() {
		if ($(this).val() == 'Disable') {
	...
	/*Start : Used for serial number POpup  Added by Hari*/
	function fetchData() {
		$("#serialProductName").val($("#productName").val());
		$("#serialProductB2BUPC").val($("#productB2BUPC").val());
		$("#serialB2bInitSerialNumQty").val($("#b2bInitSerialNumQty").val());
	}

	function resetSerialForm() {
		$("#serialB2bInitSerialNumQty").val($("#b2bInitSerialNumQty").val());
		$("#serialForm").validate().resetForm();
	}

	/* 	function submitSerialForm(action,formId){
	...
	function submitSerialForm(action, formId) {
		...
		var isValidSerialNumber = validateFields(formId,
				"serialB2bInitSerialNumQty");
		if (isValidSerialNumber) {
			var productId = $("#productId").val();
			var upc = $("#serialProductB2BUPC").val();
			var serialNumberQuantity = $("#serialB2bInitSerialNumQty").val();
			if (productId != null && productId != -1
					&& serialNumberQuantity != null
					&& serialNumberQuantity != -1) {
				$.ajax({
					url : "generateSerialNumber?productId=" + productId
							+ "&serialNumberQuantity=" + serialNumberQuantity
							+ "&upc=" + upc,
					type : "GET",
					//data		: {productId:productId,serialNumberQuantity:serialNumberQuantity},
					async : false,
					success : function(response) {
						if (response != null && response != ''
								&& response == "success") {
							$('#define-constant-serial').modal('hide');
						} else {
	...
	/*End : Used for serial number POpup  Added by Hari*/
</script>