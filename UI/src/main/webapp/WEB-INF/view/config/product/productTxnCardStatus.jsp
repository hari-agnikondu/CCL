				...
				<article class="col-lg-12">
					...
					<div class="col-lg-12 text-center">
						<c:if test="${showCopyFrom=='true' }">
							...
							<button type="submit" id="productStat" class="btn btn-primary"
								onclick="return getTxnStatDetails()">
										...
										<thead class="table-head">
											<tr>
												...
												<c:forEach items="${cardStatusList}" var="cardStatus">
													...
													<input type="checkbox" 	id="${deliveryChannel.deliveryChnlShortName}_${fn:replace(fn:replace(cardStatus,'_',''),' ', '')}_checkbox"  onclick="selectAll(this)" />
														...
														<c:choose>
															<c:when
																...
																<td><input type="checkbox"
																	...
																	checked onclick="selectAllCheck(this)"/></td>
															</c:when>
															<c:otherwise>
																<td><input type="checkbox"
																	id="${deliveryChannel.deliveryChnlShortName}_${txn.key }_${fn:replace(fn:replace(cardStatus,'_',''),' ', '')}" onclick="selectAllCheck(this)" />
																</td>
															</c:otherwise>
														</c:choose>
														<form:hidden
...
function selectAll(eleObj)
{
	...
	var cardStatus="_"+colID.split('_')[1];
