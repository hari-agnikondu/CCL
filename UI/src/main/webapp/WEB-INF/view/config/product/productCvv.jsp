						...
						<div class="tabresp tab-content">
							<div class="tab-pane fade in active graybox col-lg-6 col-lg-offset-3" >
								...
								<c:if test="${showCopyFrom=='true' }">	 
									<div class="col-lg-4">
									<label for="copyFrom"><spring:message code="Product.copyFrom" /></label>				
									</div>
									...
									<button type="button" id="productCvv" class="btn btn-primary"
									onclick="getCvvDetails()"><spring:message code="button.copy" />	
									</button>
									</div>
											
									<div>
									<span id="parentProductIdCvvError"></span>
									</div>
								</c:if>
								</div>
								...
								<div class="col-lg-12">
									...
									<label for="CVK Format"><spring:message	code="Product.embossApplicable" /></label>
									 ...
									 <div class="col-lg-4">
									<form:radiobutton value="true" path="productAttributes[embossApplicable]" id="embossApplicable_Enable" name="embossApplicable"  onclick="cvvFunc();"/>
									<label for="embossApplicable"><spring:message code="Product.embossApplicable_Status_Enable" />
									</label>
									</div>
									
									<div class="col-lg-4">	
									<form:radiobutton value="false" path="productAttributes[embossApplicable]" id="embossApplicable_Disable" name="embossApplicable" data-skin="square"  data-color="blue" onclick="embossNotApplicable();" />
								...
								<div class="col-lg-12">
									...
									name="cvkFormat" onclick="cvvFunc();" />
									<label for="cvkFormat"><spring:message code="Product.cvkFormat_Hsm_Enable" /></label>
									</div>
									
									<div class="col-lg-4">	
									<form:radiobutton value="false" path="productAttributes['cvkFormat']" id="cvkFormat_Disable" name="cvkFormat" data-skin="square" data-color="blue"  onclick="cvvFunc();" />
								 ...
								 <div class="col-lg-12">
										...
										<div class="col-lg-4">
										<form:radiobutton value="true" path="productAttributes['cardVerifyType']" id="cardVerifyType_Cvv" name="cardVerifyType" onclick="cvvFunc();" />
											...
											color='red'>*</font></label>
										 	...
										 	<div class="col-lg-8">
												<form:password path="productAttributes['cvkA']" id="cvkA" name="cvkA"
												 maxlength="50" autocomplete="off" onkeyup="return isAlphaNumeric(this)"
												  onblur ="validateCvvParameters(this.form.id,this.id)" value="${productCVV.productAttributes['cvkA']}"/>
												<div>
										...
										<div class="col-lg-8">
											...
											<div class="col-lg-8">
												<form:password path="productAttributes['cvkB']" id="cvkB" name="cvkB"
												 maxlength="50" autocomplete="off" onkeyup="return isAlphaNumeric(this)"
												 onblur ="validateCvvParameters(this.form.id,this.id)" value="${productCVV.productAttributes['cvkB']}"/>
								...
								<div class="col-lg-12 text-center">
									<button type="button" id="productCVV" class="btn btn-primary btn-normal" onclick="return cvvSubmit(this.form.id,event)">
									<i class="glyphicon glyphicon-saved"></i><spring:message code="button.update" />	
									</button>
								</div>
