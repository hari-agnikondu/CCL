								...
								<div class="col-lg-12">
									...
									<div class="col-lg-8">
										<form:input path="productAttributes['pinLength']"
											...
											autocomplete="off" onpaste="return false" readonly="true"/>
										<div>
									...
									<div class="col-lg-8">
										...
										<div class="col-lg-4">
											<form:password path="productAttributes['pvk']" id="pvk"
												name="pvk" maxlength="16" onpaste="return false"
												autocomplete="off"  onkeyup="return isHexaDecimal(this)"
												onblur="validatePvkAndDecimalisationTableFields(this.form.id,this.id)" value="${productPIN.productAttributes['pvk']}" readonly="true"/>
											<div>
									...
									<div class="col-lg-8">
										...
										<div class="col-lg-4">
											<form:input path="productAttributes['maxPinLength']"
												...
												onkeyup="return isNumeric(this)"
												onblur="validateMaxPinLengthField(this.form.id,this.id)" readonly="true"/>
											<div>
									...
									<div class="col-lg-8">
										...
										<div class="col-lg-4">
											<form:input path="productAttributes['ibmCheckLength']"
												...
												onblur="validatePinFields(this.form.id,this.id)" readonly="true"/>
											<div>
									...
									<div class="col-lg-8">
										...
										<div class="col-lg-4">
											<form:input path="productAttributes['ibmDecimalisationTable']"
												...
												onblur="return validatePvkAndDecimalisationTableFields(this.form.id,this.id)" readonly="true"/>
											<div>
