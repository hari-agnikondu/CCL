...
<script src="${pageContext.request.contextPath}/resources/js/clpvms/productLimitsAndFees.js"></script>

<form:form name="limitForm" id="limitForm" action="saveLimits"
	modelAttribute="productForm" class='form-horizontal' method="POST">
	
	<form:input path="productId" name="productId" type="hidden"/>
<%-- 	<form:input path="productName" name="productName" type="hidden"/> --%>
	<div id="feedBackTd" class="form-group text-center" style="padding-top:7px">
		...
		<c:if test="${showCopyFrom=='true'}">	
			...
			<!-- </div>
			<div class="col-lg-2"> -->
				<select class="dropdown-medium" name="copyFromProductId" id="copyFromProduct">
					<option value="-1">---Select---</option>
					<c:forEach items="${productMap}" var="parentProduct"><option value="${parentProduct.key }" <c:if test="${copyProductId==parentProduct.key}">selected="selected"</c:if>>${parentProduct.value }</option></c:forEach>
				</select><!-- </div>
				<div class="col-lg-2"> -->
				<button type="button" id="copy" value="Copy" class="btn btn-primary" onclick="copyProduct()"><spring:message code="button.copy" text="Copy" /></button>
			<!-- </div> -->
			<div>
	...
	<div class="col-lg-11 text-center" style="margin-left:15px">
                                   ...
                                   <form:select path="purseId" id="purseId"
                                            class="dropdown-medium"  onchange="ProductPurseLimit()" >
                                            <option value="-1" label="--- Select ---" />
                                            <c:forEach items="${purseList}" var="pursetype">
                                            <!--  <c:if test="${pursetype.purseType.purseTypeName=='CONSUMER FUNDED CURRENCY' || pursetype.purseType.purseTypeName=='PARTNER FUNDED CURRENCY' || pursetype.purseType.purseTypeName=='POINTS'}"> -->
								...
								<tr id="${deliveryChannel.deliveryChnlShortName}_${txn.key}"><%--  <td><input type="checkbox" value="${deliveryChannel.deliveryChnlShortName}_${txn.key}" id="${deliveryChannel.deliveryChnlShortName}_${txn.key}" name="checkedTxns"/> </td> --%>
									<td>${txn.value }<c:set var="txnShortName" value="${txn.key}" />
										...
										<form:input type="text"
													path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_minAmtPerTx]"
											...
											<form:errors path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_minAmtPerTx]" cssClass="fieldError"></form:errors>
											</td>
									<td>
												<form:input type="text"
													path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_maxAmtPerTx]"
													onkeypress="return allowNumbersWithDot(event);"  onblur="DecimalValueFormat(this); "
													...
													<form:errors path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_maxAmtPerTx]" cssClass="fieldError"></form:errors>
											</td>

									

									<td><form:input
													path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_dailyMaxCount]"
											...
											<form:errors path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_dailyMaxCount]" cssClass="fieldError"></form:errors>
											</td>
									<td>
												<form:input type="text"
													path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_dailyMaxAmt]"
													onkeypress="return allowNumbersWithDot(event);" onblur="DecimalValueFormat(this);"
										...
										<form:errors path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_dailyMaxAmt]" cssClass="fieldError"></form:errors>
											</td>
									<td>
												<form:input type="text"
													path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_weeklyMaxCount]"
													...
													style="width: -webkit-fill-available;" maxlength="4" />
											<form:errors path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_weeklyMaxCount]" cssClass="fieldError"></form:errors>
											</td>
									<td>
												<form:input type="text"
													path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_weeklyMaxAmt]"
													onkeypress="return allowNumbersWithDot(event);" onblur="DecimalValueFormat(this);"
													...
													style="width: -webkit-fill-available;"  maxlength="10"/>
											<form:errors path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_weeklyMaxAmt]" cssClass="fieldError"></form:errors>
											</td>
									
									<td>
												<form:input type="text"
													path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_monthlyMaxCount]"
													name="${deliveryChannel.deliveryChnlShortName}_${txn.key }_monthlyMaxCount" id="${deliveryChannel.deliveryChnlShortName}_${txn.key }_monthlyMaxCount"
													 onkeypress="return isNumericfn(event);" onblur="return isNumericfn(event);"
													style="width: -webkit-fill-available;"  maxlength="4" />
														<form:errors path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_monthlyMaxCount]" cssClass="fieldError"></form:errors>
											</td>
									

									<td>
												<form:input type="text"
													path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_monthlyMaxAmt]" id="${deliveryChannel.deliveryChnlShortName}_${txn.key }_monthlyMaxAmt" 
													...
													style="width: -webkit-fill-available;"  maxlength="10"/>
														<form:errors path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_monthlyMaxAmt]" cssClass="fieldError"></form:errors>
											</td>
									

									<td>
												<form:input type="text"
													path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_yearlyMaxCount]" id="${deliveryChannel.deliveryChnlShortName}_${txn.key }_yearlyMaxCount"  
													...
													style="width: -webkit-fill-available;" maxlength="4"  />
														<form:errors path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_yearlyMaxCount]" cssClass="fieldError"></form:errors>
										</td>
									...
									<td>
												<form:input type="text"
													path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_yearlyMaxAmt]" id="${deliveryChannel.deliveryChnlShortName}_${txn.key }_yearlyMaxAmt" 
													...
													style="width: -webkit-fill-available;"  maxlength="10" />
														<form:errors path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_yearlyMaxAmt]" cssClass="fieldError"></form:errors>
											</td>
