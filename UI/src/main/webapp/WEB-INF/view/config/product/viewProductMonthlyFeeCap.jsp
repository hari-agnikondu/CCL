	...
	<div id="feedBackTd" class="form-group text-center" style="padding-top:7px">
	 ...
	 <div class="col-lg-11 text-center">
                                   ...
                                   <form:select path="purseId" id="purseId"
                                            class="dropdown-medium"  onchange="ViewProductPurseMonthlyFeeCap()" >
				...
				<tbody>
					<tr>
						...
						<td><form:input type="text"
								...
								onblur="return validateFeeDescription(this)" readonly="true"/>
						...
						<td><form:select
								...
								onchange="callTimePeiodCheck()" disabled="true">
						...
						<td><form:select style="width:85px; width: -webkit-fill-available;"
								...
								id="monthlyFeeCap_assessmentDate" disabled="true">
...
<script>
	...
	function ViewProductPurseMonthlyFeeCap(){
		$("#feedBackTd").html('');
		if($("#copyFromProduct  option:selected").val()==-1){
			$("#copyFromProduct").val(null);		
		}
		
		$("#monthlyFeeCapForm").attr('action','viewProductMonthlyFeeCap');
		$("#monthlyFeeCapForm").submit();
	}
