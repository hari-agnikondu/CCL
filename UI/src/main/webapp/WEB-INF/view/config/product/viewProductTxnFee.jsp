...
<form:form name="txnFeeForm" id="txnFeeForm" action="saveTransactionFees"
	...
	<div class="col-lg-11 text-center">
                                   ...
                                   <form:select path="purseId" id="purseId"
                                            class="dropdown-medium"  onchange="ViewProductPurseTxnFee()" >
								...
								<tr id="${txn.key}">
									...
									<td><form:input type="text"
											...
											style="width: -webkit-fill-available;" maxLength="100" onblur="validateFeeDescription(this)"
											 readonly="true"/><form:errors path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_feeDesc]" cssClass="fieldError"></form:errors></td>
									...
									<td><form:checkbox
											...
											onchange="enableClawbackCount(this)" disabled="true"/><form:errors path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_clawback]" cssClass="fieldError"></form:errors></td>
									...
									<td><form:input
											...
											style="width: -webkit-fill-available;" maxlength="10" readonly="true"/><form:errors path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_feeAmt]" cssClass="fieldError"></form:errors></td>
									...
									<td><form:select
											...
											onchange="callFeeConditionChange(this)" disabled="true">
									...
									<td><form:input type="text"
											...
											onkeypress="return isNumericfn(event);;" 
											style="width: -webkit-fill-available;" maxlength="6" readonly="true"/><form:errors path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_freeCount]" cssClass="fieldError"></form:errors></td>
									...
									<td><form:input type="text"
											...
											onkeypress="return isNumericfn(event);;"
											style="width: -webkit-fill-available;" maxlength="6"
											readonly="true"/><form:errors path="productAttributes[${deliveryChannel.deliveryChnlShortName}_${txn.key }_maxCount]" cssClass="fieldError"></form:errors></td>
									...
									<td><form:checkbox
											...
											name="${deliveryChannel.deliveryChnlShortName}_${txn.key }_monthlyFeeCapAvail" disabled="true"/>
