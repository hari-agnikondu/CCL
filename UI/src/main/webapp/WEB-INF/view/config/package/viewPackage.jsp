...
<body class="dashboard" onload="onloadDiv()">
	<form:form name="viewPackageForm" id="viewPackageForm" method="post"
		...
		<a href="#viewPackage" data-toggle="tab" id="mandatory" onClick="Manadatory();"><i class="glyphicon glyphicon-tags"></i> 
		<spring:message code="package.viewPackageLabel" /></a></li>
			<li class="SubMenu">
	<a href="#viewPrinter" data-toggle="tab" id="nonMandatory" onClick="NonManadatory();"><i class="glyphicon glyphicon-tags"></i> 
							...
							<div class=" graybox tab-pane fade in active" id="package">
								<div class="form-inline">
									...
									<input type="hidden" name="jsPath" id="jsPath"
										...
										<input id="viewpackageId"
										name="viewpackageId" type="hidden" value="${viewpackageId}" />
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-6">
												<form:select path="replacementPackageId"
													id="replacementPackageId" disabled="true" class="dropdown-medium" >
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-6">
												<form:select path="packageAttributes[shipMethods]"
													id="shipMethods" class="dropdown-medium" multiple="true" disabled="true">
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-6">
												<form:select
													...
													id="replacementshipMethods" class="dropdown-medium" disabled="true">
													<form:options items="${shipmentMethodList}" />
												</form:select>
											</div>
										</div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-6">
												<form:select path="packageAttributes[expRepshipMethods]"
													id="expRepshipMethods" class="dropdown-medium" disabled="true">
													<form:options items="${shipmentMethodList}" />
												</form:select>
											</div>
										</div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-6">
												<form:input path="packageAttributes[carrierId]"
													...
													type="textarea" maxlength="4" onkeyup="return isNumeric(this)" readonly="true" />
												<div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-6">
												<form:input path="packageAttributes[embossLine3]"
													...
													type="textarea" maxlength="50" onkeyup="return isAlphaNumericPackage(this)" readonly="true" />
												<div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-6">
												<form:input path="packageAttributes[envelopeId]"
													...
													type="textarea" maxlength="10" onkeyup="return isAlphaNumericWithSpacePackage(this)" readonly="true" />
												<div>
											...
											<div class="col-lg-12">
												...
												<div class="col-lg-6">
													<form:select path="packageAttributes[fulfillmentMethod]"
														id="fulfillmentMethod" class="dropdown-medium" disabled="true">
														<form:option value="-1" label="--- Select ---" />
											...
											<div class="col-lg-12">
												...
												<div class="col-lg-6">
													<form:input path="packageAttributes[bundleSize]"
														id="bundleSize" class="textbox textbox-xlarge" readonly="true"
											...
											<div class="col-lg-12 text-center">
												...
												<div class="">
													...
													<button type="button" class="btn btn-primary gray-btn"
														onclick="goBackToPackageFromView();">
