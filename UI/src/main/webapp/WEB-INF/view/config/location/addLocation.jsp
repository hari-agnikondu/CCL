...
<body>
	<div class="body-container">
		<div class="container">
			<form:form name="addLocation" id="addLocation" method="POST"
				class='form-horizontal ' commandName="addLocation">
				...
				<section class="content-container">
					<article class="col-lg-12">
						<ul class="nav nav-tabs col-lg-6 col-lg-offset-3">
							<li class="active SubMenu"><a href="#addLocation"
								data-toggle="tab"><i class='glyphicon glyphicon-tags'></i> <spring:message
										code="location.addLocation" /></a></li>
						</ul>
							...
							<div class="col-lg-12">
										...
										<div class="col-lg-6">
											...
											onblur="validateDropDownForLocation(this.form.id,this.id)" >
												...
												<option value="${merchantList.merchantId}" selected="true">${merchantList.merchantName}</option></c:when>
												<c:otherwise>
								...
								<div class="col-lg-12">
									...
									<div class="col-lg-6">
										<form:textarea path="addressOne" id="addressOne" class="trim"
								...
								<div class="col-lg-12 padding-top-sm">
									...
									<div class="col-lg-6">
										<form:textarea path="addressTwo" id="addressTwo" class="trim"
											type="textarea" maxLength="255" rows="5" cols="51" style="resize:none"
									...
									<div class="col-lg-12">
										...
										<div class="col-lg-6">
											<form:select path="stateCodeID" id="state"  
												...
												<%-- <form:option value="1" label="0:INACTIVE" /> --%>
											</form:select>
						...
						<article class="col-lg-12">					
								<div class="col-lg-12 text-center">
									<button type="button" 
										...
										onclick="formSubmitForAddLocation(this.form.id,event);">
										<i class="glyphicon glyphicon-plus"></i>
										<spring:message code="button.add" />
									</button>
									<button type="button" onclick="goResetForAddLocation();"
										class="btn btn-primary gray-btn">
										<i class="glyphicon glyphicon-refresh"></i>
										<spring:message code="button.reset" />
									</button>
									<button type="button" class="btn btn-primary gray-btn"
										onclick="backAddToLocationConfig();">
