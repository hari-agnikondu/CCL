...
public class JobScheduler {
	...
	public String toString() {
		return "JobScheduler [jobId=" + jobId + ", totalDays=" + totalDays + ", jobName=" + jobName + ", dayOfMonth="
				...
				+ ", insUser=" + insUser + ", successMailUser=" + successMailUser + ", failMailUser=" + failMailUser
				+ "]";
	}
