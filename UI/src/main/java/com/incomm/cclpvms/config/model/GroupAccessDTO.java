...
public class GroupAccessDTO implements Serializable {
	...
	public String toString() {
		return "GroupAccessDTO [groupAccessId=" + groupAccessId + ", productName=" + productName + ", groupAccessName="
				+ groupAccessName + ", productId=" + productId + ", partnerId=" + partnerId + ", partnerName="
				+ partnerName + ", insUser=" + insUser + ", insDate=" + insDate + ", lastUpdUser=" + lastUpdUser
				+ ", lastUpdDate=" + lastUpdDate + ", groupAccessPartnerList=" + groupAccessPartnerList
				+ ", partnerList=" + partnerList + ", partnerPartyType=" + partnerPartyType + ", selectedPartnerList="
				+ selectedPartnerList + ", partnerArray=" + Arrays.toString(partnerArray) + "]";
	}
