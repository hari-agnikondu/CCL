...
public class CCFConfDetail {

	private String ccfFormatVersion = "";
	private long confID;
	...
	public String getCcfFormatVersion() {
		return ccfFormatVersion;
	}

	public void setCcfFormatVersion(String ccfFormatVersion) {
		this.ccfFormatVersion = ccfFormatVersion;
	}
